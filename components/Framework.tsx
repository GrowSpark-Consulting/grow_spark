/**
 * Transcribed from sections\framework.html by scripts/html-to-tsx.py.
      ...
      <section id="framework" className="py-28 lg:py-36 bg-ink overflow-hidden scroll-mt-24" data-framework="">
        ...
        <div className="mx-auto max-w-[var(--container-page)] px-5 sm:px-8">
          ...
          <div className="section-head on-dark" data-reveal="">
            ...
            {' '}
            <p>
              A disciplined, five-phase path from diagnosis to sustained impact — applied consistently across every engagement.
            </p>
            {' '}
          </div>
          {' '}
            ...
            <div className="flex flex-col gap-9 lg:flex-row lg:gap-0 relative">
              ...
              <div className="framework-step flex items-center gap-5 lg:flex-col lg:items-center lg:text-center lg:flex-1 lg:px-4 relative z-10" data-fw-step="" data-reveal="">
                ...
                <div>
                  ...
                  <p className="text-[#9BA1A7] text-[13.5px] leading-relaxed lg:max-w-[180px]">
                    Understand the business, the market and the leadership team's ambition.
                  </p>
                  {' '}
                </div>
                {' '}
              ...
              <div className="framework-step flex items-center gap-5 lg:flex-col lg:items-center lg:text-center lg:flex-1 lg:px-4 relative z-10" data-fw-step="" data-reveal="">
                ...
                <div>
                  ...
                  {' '}
                  <p className="text-[#9BA1A7] text-[13.5px] leading-relaxed lg:max-w-[180px]">
                    Identify the true constraints holding growth and performance back.
                  </p>
                  {' '}
                </div>
                {' '}
              ...
              <div className="framework-step flex items-center gap-5 lg:flex-col lg:items-center lg:text-center lg:flex-1 lg:px-4 relative z-10" data-fw-step="" data-reveal="">
                ...
                <div>
                  ...
                  {' '}
                  <p className="text-[#9BA1A7] text-[13.5px] leading-relaxed lg:max-w-[180px]">
                    Architect the strategy, systems and operating model to solve them.
                  </p>
                  {' '}
                </div>
                {' '}
              ...
              <div className="framework-step flex items-center gap-5 lg:flex-col lg:items-center lg:text-center lg:flex-1 lg:px-4 relative z-10" data-fw-step="" data-reveal="">
                ...
                <div>
                  ...
                  {' '}
                  <p className="text-[#9BA1A7] text-[13.5px] leading-relaxed lg:max-w-[180px]">
                    Implement the transformation with the team, in the business.
                  </p>
                  {' '}
                </div>
                {' '}
              ...
              <div className="framework-step flex items-center gap-5 lg:flex-col lg:items-center lg:text-center lg:flex-1 lg:px-4 relative z-10" data-fw-step="" data-reveal="">
                ...
                <div>
                  ...
                  {' '}
                  <p className="text-[#9BA1A7] text-[13.5px] leading-relaxed lg:max-w-[180px]">
                    Sustain momentum through managed growth and continuous improvement.
                  </p>
                  {' '}
                </div>
                {' '}
          ...
          {' '}
          <p className="text-center text-[#9BA1A7] text-[13.5px] mt-16" data-reveal="">
