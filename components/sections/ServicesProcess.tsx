/**
 * Transcribed from sections/services-process.html by scripts/html-to-tsx.py.
        ...
        <div className="mx-auto max-w-[var(--container-page)] px-5 sm:px-8 grid lg:grid-cols-[1fr_auto] items-center gap-12">
          ...
          <div>
            ...
            <h2 className="subsection-heading mb-4 max-w-[520px]">
              Every service runs through the same disciplined framework.
            </h2>
            {' '}
            <p className="text-ink-soft text-[17px] leading-relaxed max-w-[520px] mb-7">
              Whichever capability you start with, it's delivered through the Grow Spark Business Transformation Framework™ — the same five-phase discipline behind every engagement.
            </p>
            {' '}
